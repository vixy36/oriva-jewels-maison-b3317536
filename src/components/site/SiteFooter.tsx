      ...
      <div className="relative border-b border-white/5">
        <div className="mx-auto max-w-[1600px] px-6 py-24 md:px-10 md:py-32 text-center">
          ...
          >
            ...
            <button
              type="submit"
              className="text-[10px] tracking-[0.32em] uppercase text-gold hover:text-ivory transition inline-flex items-center gap-1"
            >
      ...
      <div className="relative mx-auto max-w-[1600px] px-6 py-20 md:px-10 md:py-24">
        <div className="grid gap-14 md:grid-cols-12">
          <div className="md:col-span-4">
            ...
            <p className="mt-1 font-sans text-[11px] tracking-[0.55em] text-gold">— JEWELS —</p>
        ...
        <div className="mt-20 flex flex-col gap-3 border-t border-white/5 pt-8 md:flex-row md:items-center md:justify-between">
          <p className="text-[10px] tracking-[0.35em] uppercase text-ivory/40">
...
function FooterCol({ title, links }: { title: string; links: { label: string; to: string }[] }) {
  return (
    <div>
      <p className="text-[10px] tracking-[0.42em] uppercase text-gold">{title}</p>
