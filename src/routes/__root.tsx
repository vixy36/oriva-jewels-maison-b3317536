...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: ({ loaderData }) => {
    ...
    const defaultTitle = "Oriva Jewels | Fine Natural & Lab Grown Diamond Jewellery";
    const defaultDesc = "Oriva Jewels is a fine jewellery maison crafting exceptional natural and lab grown diamond engagement rings, earrings, bracelets and bridal pieces.";
...
})(window,document,'script','dataLayer','GTM-MTLNTXMC');`,
          }}
        />
