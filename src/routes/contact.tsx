      ...
      <section className="mx-auto max-w-[1500px] px-6 md:px-16 grid gap-16 md:grid-cols-12 md:gap-20">
        ...
        <Reveal delay={100} className="md:col-span-7">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full bg-gold text-obsidian py-5 text-[11px] tracking-[0.4em] uppercase hover:bg-ivory transition mt-4"
            >
              Request Appointment
            </button>
          </form>
  ...
  const content = (
    <div className="flex gap-6 border-t border-white/8 pt-6">
      <div className="shrink-0 flex flex-col items-center gap-3">
        <span className="text-[10px] tracking-[0.42em] text-gold">{n}</span>
        <div className="grid h-11 w-11 place-items-center border border-white/10 text-gold">
          <Icon className="h-4 w-4" strokeWidth={1.3} />
        </div>
      </div>
      <div>
        <p className="text-[10px] tracking-[0.42em] uppercase text-ivory/50">{title}</p>
